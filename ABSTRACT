...
to enable the instant provision of information, while also ensuring the application’s capacity for future expansion, allowing the addition of new features.
The final outcome of the project was successful, with the application fully meeting the initial requirements set
