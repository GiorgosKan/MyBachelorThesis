...
public class MuseumsLocation extends AppCompatActivity {
    ...
    private static final String TAG = "MuseumsLocation";
    Button metagetGPS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_museumslocation);
                    ...
                    switch (statusCode) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            try {
                                ...
                                rae.startResolutionForResult(MuseumsLocation.this, REQUEST_CHECK_SETTINGS);
