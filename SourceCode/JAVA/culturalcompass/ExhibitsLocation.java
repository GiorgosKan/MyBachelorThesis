...
public class ExhibitsLocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exhibitslocation);
                    ...
                    switch (statusCode) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            try {
                                ...
                                rae.startResolutionForResult(ExhibitsLocation.this, REQUEST_CHECK_SETTINGS);
